...
def get_args():
    ...
    par.add_argument('-subsample', action="store_true", help='subsample_majority subgroup')
...
if __name__ == "__main__":
    ...
    if "tasks" in args.dataset:
        ...
        args.output_path, args.cache_path, args.reset_tasks, args.tune, args.subsample, args.mini_tasks)    
    else:        
        print("input:{}\ndataset:{}\nfeature_type:{}\noutput:{}\ncache:{}\nclear_results:{}\ntune:{}\n".format(args.input_path, args.dataset, args.feature_type, args.output_path, args.cache_path, args.clear_results, args.tune))
        run_analyses(args.input_path, args.dataset, args.feats_path, args.feature_type, args.output_path, 
                    args.cache_path, args.clear_results, args.tune, args.subsample)
