...
fname = "{}_{}_gender_all_res.pkl".format(dataset, model).lower()
df_res, df_res_M, df_res_F, df_res_delta, title = list(read_cache(output_path+fname))
...
random.seed(1)
random.sample(range(0, 10000), N_SEEDS)
